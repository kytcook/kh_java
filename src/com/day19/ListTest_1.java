...
/*
  인스턴스화 유형 3가지
  왜 하는거니? 클래스 내부에 정의된 변수, 메소드(static 있고, 없는)
  첫번째 유형 - 기초
  ...
  변수와 메소드를 누릴 수 있다. - 다른 클래스의 메소드를 호출할 수 있따. - 재사용할 수 있다.
  public A methodA(){}
  ...
  그런데 List는 다른 타입도 담을 수 있고, 끼워넣기도 가능하고(ex - List.add(2,"토마토))
  add하면 계속 방이 늘어나고 remove(3) 방이 줄어든다.
  Object이면 타입이 달라도 모두 담을 수 있다.  
  
  
  세번째 유형 - 다형성을 기대할 수 있다.
  List nameList = new ArrayList();
  // 다이아몬드 연산자 < > : 제네릭 - 내 안에 있는 타입을 명시한다. 
  List<String> nameList2 = new ArrayList<String>();
  //생성부에 오는 명시적인 타입은 생략 가능하다. 대신 < > 다이아몬드 연산자를 붙여야 한다.
  List<String> nameList2 = new ArrayList<>();
  
  // get(int i) : Object - API에 나온다
  ...
  // 제네릭을 사용하는 경우에는 다이아몬드 연산자 안에 타입을 적어 놓았으므르로
