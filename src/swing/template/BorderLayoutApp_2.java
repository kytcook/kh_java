...
/* BorderLayoutApp.java 소스는 하나인데 
   ...
   이벤트 처리를 담당하는 인터페이스가 필요해요 - ActionListener 
	-> 인터페이스가 정의하고 있는 actionPerformed메소드를 재정의해야함 */
class BorderLayoutView2 implements ActionListener{
	...
	// 메소드 오버라이딩 - 어노테이션 - 강제사항을 갖고 있다
	// 북쪽 버튼을 클릭할 때 출력문이 출력
	@Override
...
public class BorderLayoutApp_2 {

	public static void main(String[] args) {
		//insert here
		// 클래스타입 변수명(주소번지출력) = new 클래스명();
		BorderLayoutView2 blView = new BorderLayoutView2();
		blView.initDisplay();//메소드 호출
		System.out.println(blView); // BorderLayoutView2의 주소번지를 가져온다
	}
