...
public class BoardDao {
	...
	public List<Board> selectBoard(Connection conn) {
		...
		List<Board> boardList = new ArrayList<>();// 인스턴스화가ㅏ 된 후, 아래 while문에서 담긴다
		StringBuilder sql = new StringBuilder();
