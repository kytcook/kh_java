...
public class TalkServerThread_test extends Thread {
	public TalkServer_test ts = null;
	Socket client = null;
	ObjectOutputStream oos = null;
	ObjectInputStream ois = null;
	String chatName = null;//현재 서버에 입장한 클라이언트 스레드 닉네임 저장
	public TalkServerThread_test(TalkServer_test ts) {
		this.ts = ts;
		...
		try {
			...
			for(TalkServerThread_test tst:ts.globalList) {
