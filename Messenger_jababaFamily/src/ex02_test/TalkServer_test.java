...
public class TalkServer_test extends JFrame implements Runnable{
	...
	public void run() {
		...
		try {
			...
			while(!isStop) {
				...
				TalkServerThread tst = new TalkServerThread_test(this);
				tst.start();
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void main(String[] args) {
		TalkServer_test ts = new TalkServer_test();
		ts.initDisplay();
