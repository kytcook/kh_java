...
public class TalkServer extends JFrame implements Runnable {
	...
	List<TalkServerThread> globalList = null; // 타입에 상관없이 모두 담을 수 있다. 끼워넣기가 된다 (끼워넣기가 안된다 : like배열)
