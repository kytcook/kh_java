...
public class Parameter_2 {
	...
	public static void main(String[] args) {
		...
		Dog yourDog = methodA(myDog); // 원본이 넘어간다.( 11번 라인에 있는 클래스의 주소)
		//원본의 주소번지가 파라미터로 넘어갔으니까 원본이 2로 바뀐 것임.
		System.out.println("main myDog.leg ==> "+myDog.leg);
		// mthodA안에서 5번에 생성된 객체는 인스턴스화만 되었을 뿐 아무런 값의 변화가 없다.
		// 따라서 전변의 값은 디폴트값 그대로의 상태 입니다.
