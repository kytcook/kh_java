package test.kh0503;
//UML 도구를 이용해서 클래스 설계 할 때 +:public, -:private, #:protected
class Circle {
	...
	public Circle(double radius) { //파라미터가 있는 생성자가 하나라도 있으면 디폴트 생성자를 JVM이 제공안함
		this.radius = radius; // 생성자 호출시 파라미터로 넘어온 값이(Call by value) 전번에 담긴다.
	}
	...
	public void setRadius(double radius) { // radius - 3.1이 복사된다. call by value이다.
...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 왜냐하면 13번 라인에서 디폴트생성자가 아닌 그러니까 파라미터가 없는 생성자가 아닌
