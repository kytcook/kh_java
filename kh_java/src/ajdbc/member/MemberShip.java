...
//		initDisplay(); 이걸 여기다가 넣으면 2번 실행된다,
	 ...
	 *  만일 boolean을 선택했다면 false이면 : 사용할 수 있다. true이면 : 사용할 수 없다.
	    ...
	    질문 4: java.sql.SQLSyntaxErrorException: ORA-00911: 문자가 부적합합니다
	    		쿼리문 뒤에 세미콜론을 붙인 경우에 발생하는 오류입니다.
	************************************************************************/
	...
	public void initDisplay() {
		...
		jtf_address.setBounds(120,129, 250, 20);
...
//				A a = new A(); 
	...
	public String getZipcode() {return jtf_id.getText();}
	public void setZipcode(String mem_zipcode) {jtf_zipcode.setText(mem_zipcode);}
	
	public String getAddress() {return jtf_id.getText();}
