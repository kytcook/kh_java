...
public class JTableSample_1 implements ActionListener{
	...
	// 만일 값을 접근하려면 DefaultTableMoel안에 데이터 셋이 있다
	...
	// 속지를 그리는데 사용된다. - 이 속지에 처리버튼과 종료 버튼을 추가해보자
	...
	public void initDisplay() {
		jbtn_account.addActionListener(this); // 감지한다 call back함수 호출한다.
	...
	@Override
	public void actionPerformed(ActionEvent e) { //자바에서 대신 주입해 준다. ActionEvent 그래서 null이 아니야
