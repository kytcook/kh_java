...
// POJO 프레임워크가 갖고 있는 복잡도에 대해 생각해 보세요.
// 새로운 업무가 추가되는 경우 유연하게 조립이 가능한지에 대해 이야기 해 보세요.
// 뭔가 수정되어지는 부분들이 복잡도가 증가되고 있나?? 아니면 코드양만 늘고 있나??
// ActionSupport클래스와 의존관계가 있나? - 수정해야할 부분이 있나???
// Controller3 인터페이스와 의존관계가 있나? - 있나|없나? 어떤 점이 불편한가??
// HandlerMapping클래스와 의존관계가 있나?? - 수정해야할 부분이 있나|없나??
public class DeptControlloer implements Controller3 {
