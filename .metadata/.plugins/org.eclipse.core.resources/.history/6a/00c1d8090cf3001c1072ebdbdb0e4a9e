...
public class ChatView extends JFrame implements ActionListener {
	...
	JPanel jp_first_south1 		= 	new JPanel();
	JPanel jp_first_south2		= 	new JPanel();
	JTextField jtf_msg 			=	new JTextField(20);// south속지 center
	JButton jbtn_send 			= 	new JButton("전송");// south속지 east
	JButton jbtn_happy 			= 	new JButton("이모티콘");
	JTextArea jta_display 		= 	null;
//	JTextArea jta_display2 		= 	new JTextArea(3.30);
	...
	public void initDisplay(boolean is) {
		...
		jp_first_south1.setLayout(new BorderLayout());
		//jp_first_south2.add(jbtn_happy);
		//jp_first_south2.add(jbtn_send);
		
		//jp_first_south1.add("Center", jtf_msg);
		//jp_first_south1.add("East", jp_first_south2);
		...
		//jp_first.add("Center", jsp_display);
		//jp_first.add("South", jp_first_south1);
		this.add(jspp);
		//this.add(jp_first);
		//this.add(jp_second);
	...
	public static void main(String args[]) {
		new ChatView(null).initDisplay(true);
	}
}
